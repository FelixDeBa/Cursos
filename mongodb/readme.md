...
- [Para crear una base de datos ](#para-crear-una-base-de-datos-)
  - [Para listar las bases de datos existentes ](#para-listar-las-bases-de-datos-existentes-)
- [Para create una coleccion ](#para-create-una-coleccion-)
  - [Para listar las colecciones/tablas existentes ](#para-listar-las-coleccionestablas-existentes-)
- [CRUD ](#crud-)
  - [Agregar usuario (CREATE) ](#agregar-usuario-create-)
  - [Buscar usuarios (READ) ](#buscar-usuarios-read-)
    - [Aplicando filtros: ](#aplicando-filtros-)
  - [Actualizar un usuario (UPDATE) ](#actualizar-un-usuario-update-)
  - [Eliminar Un registro (DELETE) ](#eliminar-un-registro-delete-)
- [Operaciones entre dos Tablas/Colecciones ](#operaciones-entre-dos-tablascolecciones-)
  - [Conectar una clave principal y una clave foranea ](#conectar-una-clave-principal-y-una-clave-foranea-)
  - [Para buscar en una tabla enlazada con otra ](#para-buscar-en-una-tabla-enlazada-con-otra-)
  - [Una manera que encontre un poco mas elegante de buscar ](#una-manera-que-encontre-un-poco-mas-elegante-de-buscar-)
  - [Para actualizar una tarea de un usuario ](#para-actualizar-una-tarea-de-un-usuario-)
  - [Agregar un nuevo campo a la tabla ](#agregar-un-nuevo-campo-a-la-tabla-)
  - [Si quisiera eliminar una tarea que corresponde a un usuario: ](#si-quisiera-eliminar-una-tarea-que-corresponde-a-un-usuario-)
- [Comando insertMany() ](#comando-insertmany-)
- [Agregar un registro con ID Personalizado ](#agregar-un-registro-con-id-personalizado-)
- [Uso de find ](#uso-de-find-)
  - [find ](#find-)
- [Actualizaciones/Cambios en los datos ](#actualizacionescambios-en-los-datos-)
  - [updateOne ](#updateone-)
  - [update ](#update-)
  - [updateMany ](#updatemany-)
  - [replaceOne ](#replaceone-)
- [Cursores (Aplicar funciones de javascript) ](#cursores-aplicar-funciones-de-javascript-)
- [Proyecciones ](#proyecciones-)
    - [Ejemplo de Proyecciones ](#ejemplo-de-proyecciones-)
- [Crear backups de bases de datos ](#crear-backups-de-bases-de-datos-)
- [Restaurar una base de datos ](#restaurar-una-base-de-datos-)
- [Eliminar una coleccion ](#eliminar-una-coleccion-)
- [Eliminar una base de datos ](#eliminar-una-base-de-datos-)
- [Esquemas (Schema) ](#esquemas-schema-)
  - [Crear documentos/tablas con esquema fijo ](#crear-documentostablas-con-esquema-fijo-)
- [Tipos de Datos ](#tipos-de-datos-)
      - [Cadenas ](#cadenas-)
      - [Entero ](#entero-)
      - [Objeto int de mongoDB ](#objeto-int-de-mongodb-)
      - [Float ](#float-)
      - [Booleano ](#booleano-)
      - [Fecha ](#fecha-)
      - [Listas ](#listas-)
  ...
  - [Ejemplo de Coleccion con esquema fijo (Fixed schema) ](#ejemplo-de-coleccion-con-esquema-fijo-fixed-schema-)
