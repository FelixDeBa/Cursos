        ...
        <>
          ...
          <div className="xl:flex justify-between pr-7">
            ...
            <div className="relative basis-3/5">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center basis-1/5">
            ...
            <ul className="flex flex-col justify-around items-center xl-items-start py-5 gap-3">
              {expenseCategories.map((entry, index) => (
                <li key={`legend-${index}`} className="flex items-center text-xs">
                  <span className="mr-2 w-2 h-3 rounded-full" style={ {backgroundColor: colors[index % colors.length]} }></span>
                  {entry.name}
                </li>
              ))}
            </ul>
