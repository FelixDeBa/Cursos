...
const StatCard = ({
    ...
    return (
        <div className="md:row-span-31 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between">
            <div>
                <div className="flex justify-between itemc-center mb-2 px-5 pt-4">
